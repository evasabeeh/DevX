    ...
    return (
        <div className="relative w-100 h-100 mx-auto flex items-center justify-center">
            ...
            >
                ...
                <path
                    d="M -11 0 L -15 -35 C -15 -37 -14 -40 -12 -41 
                       L 28 -51 C 31 -52 36 -48 35 -42 
                       L 31 -8 C 30 -6 30 -6 27 -4 
                       L -6 4 C -10 4 -11 2 -11 0"
                    fill="darkgreen"
            ...
            <div className="relative z-10 text-center px-4 mt-14">
                ...
                <p className="text-sm text-gray-500 mb-1">UPSC Aspirant</p>
